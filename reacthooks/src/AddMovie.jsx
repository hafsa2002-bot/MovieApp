  ...
  return (
    <>
        ...
        <form onSubmit={handleSubmit} method='post' className='border w-1/3 flex flex-col px-5 bg-blue-950 rounded-xl py-3 text-white text-lg m-auto gap-4'>
            ...
            <input className='border   rounded-lg px-3 py-1 ' type='text' id='movieName' name='movieName' value={movieName} onChange={(e) => setMovieName(e.target.value)} />
            <label>Release date: </label>
            <input className='border rounded-lg px-3 py-1 '  type='date' id='movieDate' name='movieDate'value={movieDate} onChange={(e) => setMovieDate(e.target.value)} />
            <label>Movie Photo:</label>
            <input  className="border rounded-lg px-3 py-1 "  type='file' name='moviePhoto' accept='image/*' onChange={handleFileChange} />
            <label>Movie Trailer(Youtube Link): </label>
            <input className='border rounded-lg px-3 py-1 ' type='text' name='trailer' value={trailer} onChange={(e) => setTrailer(e.target.value)}  />
