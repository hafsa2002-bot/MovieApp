...
function DocumentaryMovies({genreID}) {
  const [documentaryMovies, setDocumentaryMovies] = useState([])
  const api_key = "8def2fa47c86a07209cafb1c6eb4409b"

  const fetchDocumentaryMovies = (Id) => {
      ...
      .then(response => setDocumentaryMovies(response.data.results))
      .catch(error => console.log("Error when fetching popular movies: ", error))
  }

  useEffect(() => {
      fetchDocumentaryMovies(genreID)
  }, [])
  return (
    <div>
      {
